...
# Check version
#  Python 3.6.9 on linux (Ubuntu 18.04.5 LTS)
#  numpy 1.19.1
#  matplotlib  3.2.1
#  scipy 1.4.1
...
class Class_Analysis1(object):
    ...
    def plot_image(self, yg=None, LabelOn= True, template=None, plot_show_enable=True):
        #
...
def show_xy():
    #
    print( 'Ana0.xyb_list', Ana0.xyb_list )
    print( 'Ana1.xyc_list', Ana1.xyc_list )
    x0b=Ana0.xyb_list[0]
    x0c=Ana1.xyc_list[0]
    print( 'delay time ', (x0c-x0b) *  (1.0 / (sr0 / Ana0.dsf)))

if __name__ == '__main__':
    #
    parser = argparse.ArgumentParser(description='Compare matching portion of two spectrograms and show its difference')
    parser.add_argument('--wav_file_template', '-t', default='wav/original_sound.wav', help='template wav file name(16bit)')
    parser.add_argument('--wav_file_matching', '-m', default='wav/mic_record.wav', help='matching wav file name(16bit)')
    ...
    # draw image
    Ana1.plot_image( plot_show_enable=False) # At once draw
